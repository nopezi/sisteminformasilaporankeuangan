...
--
-- Host: 127.0.0.1
-- Generation Time: 29 Jan 2018 pada 11.54
...
(15, 4, 'Ade', '06', 'maret', 2018, 'sdfd', 'sff', '34', 343, 34, 309),
...
(55, 'Fikri', 'Cia Media', 'abcproyektor@gmail.com', '08987377644', 'Caturtunggal, Kecamatan Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta'),
...
--
ALTER TABLE `pemasukkan`
  MODIFY `id_masuk` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
